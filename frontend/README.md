...
VIN-120 adds checkout submission, confirmation and order history; payments remain planned. See the canonical completion plan for merge/deployment status. See the [cart architecture and manual
