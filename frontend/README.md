...
VIN-120 checkout submission, confirmation and order history merged in PR #188; VIN-30 sandbox payment code is implemented in PR #194; activation and hosted proof remain pending. See the canonical completion plan for merge/deployment status. See the [cart architecture and manual
