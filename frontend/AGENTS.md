...
Server-mediated sessions, registration/login screens, profile/navigation and the signed-in cart storefront are implemented; checkout submission, confirmation and order history are implemented on VIN-120's branch; verify merge/deployment status in the canonical plan. Development and production demos are deployed.
