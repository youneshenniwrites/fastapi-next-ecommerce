...
The Next.js storefront, accounts and signed-in cart UI are implemented; VIN-120 checkout/history UI merged in PR #188; VIN-30 sandbox payments merged in PR #194 and were verified on development on 23 September; production payments remain disabled. See the canonical completion plan for merge/deployment status.
