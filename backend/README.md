...
The Next.js storefront, accounts and signed-in cart UI are implemented; VIN-120 checkout/history UI merged in PR #188; VIN-30 sandbox payment code merged in PR #194; activation and hosted proof remain pending. See the canonical completion plan for merge/deployment status.
