...
PR #181 is merged. VIN-120 customer checkout/history merged in PR #188. VIN-30 sandbox payments is in progress; implementation and hosted proof are tracked in the canonical plan.
