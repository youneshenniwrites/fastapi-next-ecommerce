...
PR #181 is merged. VIN-120 customer checkout/history merged in PR #188. VIN-30 sandbox implementation merged in PR #194; development activation and hosted proof remain in progress in the canonical plan.
...
Sandbox payments VIN-30 is in progress; Azure #31 is deferred. See
